...
export const normalizeProfile = (profile: any = {}): EnhancedUserProfile => ({
  ...
  monthly_income:
    profile.monthly_income === null || profile.monthly_income === undefined || profile.monthly_income === ''
      ? null
...
export const normalizeSpouse = (spouse: any): SpouseProfile | null => {
  if (!spouse) {
    return null;
  }
...
export const normalizeChildren = (children: any[]): ChildProfile[] =>
