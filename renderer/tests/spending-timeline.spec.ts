...
import { goHome } from './helpers/renderer-app';
import en from '../src/i18n/locales/en.json' with { type: 'json' };
import he from '../src/i18n/locales/he.json' with { type: 'json' };
import { dateAfter, setupSpendingTimeline } from './helpers/spending-timeline';
...
test('home rolling allocation follows dashboard dates and switches between spending types and totals', async ({ page }) => {
  const state = await setupSpendingTimeline(page);
  await goHome(page);
