          ...
          <Paper sx={{
            ...
            <Box sx={{ mb: 3 }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                <Typography variant="body2" sx={{
                  color: "text.secondary"
                }}>{t('incomeVsExpense.income')}</Typography>
                <Typography
                  variant="body1"
                  sx={{
                    fontWeight: "bold",
            ...
            <Box sx={{ mb: 3 }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                <Typography variant="body2" sx={{
                  color: "text.secondary"
                }}>{t('incomeVsExpense.expenses')}</Typography>
                <Typography
                  variant="body1"
                  sx={{
                    fontWeight: "bold",
            ...
            <Box sx={{ mt: 'auto', pt: 2, borderTop: `1px solid ${alpha(theme.palette.divider, 0.1)}` }}>
              <Grid
                ...
                <Grid>
                  ...
                  <Typography variant="h4" color={(data.totalIncome - data.totalExpenses) >= 0 ? 'success.main' : 'error.main'} sx={{
                    fontWeight: "bold"
                  }}>
