...
export const CATEGORY_ICON_REGISTRY: Readonly<Record<string, ElementType>> = Object.freeze({
  AccountBalance,
...
export function resolveCategoryIcon(iconName?: string | null): ElementType {
  if (!iconName) return CATEGORY_ICON_FALLBACK;
  return CATEGORY_ICON_REGISTRY[iconName] ?? CATEGORY_ICON_FALLBACK;
}
